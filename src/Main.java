...
public class Main {
    ...
    public static int[] heroesHealth = {270, 260, 250, 500};
    ...
    public static void medicHeal() {
        ...
        if (heroesHealth[chance] > 0 && heroesHealth[chance] < 100 && heroesHealth[3] > 0 && heroesAttackType[chance] !=heroesAttackType[3]) {
            heroesHealth[chance] += healingUnit;
    ...
    public static void printStatistics() {
        ...
        System.out.println("Boss health: " + bossHealth + "  damage: " + bossDamage + "  defence: " + (bossDefence == null ? "NoDefence" : bossDefence) + "  Medic heal: " + healingUnit);
        for (int i = 0; i < heroesHealth.length; i++) {
